# `Cairo_NoGPL_jll.jl` (v1.18.5+0)

[![deps](https://juliahub.com/docs/Cairo_NoGPL_jll/deps.svg)](https://juliahub.com/ui/Packages/General/Cairo_NoGPL_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/8123a059f694032c31ef0704378bd1cc8c153d3d/C/Cairo/Cairo_NoGPL/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `Cairo_NoGPL_jll.jl` have been built from these sources:
...
`Cairo_NoGPL_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `Cairo_NoGPL_jll.jl`:
